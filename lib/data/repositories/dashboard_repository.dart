...
class DashboardRepository {
  ...
  Future<GetCaDashboardDataModel> getCaDashboardApi(
  ...
  //**** Get Sub Ca Dashboard API ****//
  Future<SubCaDashboardModel> getSubCaDashboardApi(
      {required Map<String, dynamic> query}) async {
    var http = HttpService(
        isAuthorizeRequest: true,
        baseURL: EndPoints.baseUrl,
        endURL: EndPoints.getSubCaDashboardUrl,
        queryParameters: query,
        bodyType: HttpBodyType.JSON,
        methodType: HttpMethodType.GET);
    try {
      Response<dynamic>? response = await http.request<dynamic>();
      debugPrint('reminder Response ${response?.data}');
      return SubCaDashboardModel.fromJson(response?.data);
    } catch (e) {
      debugPrint('error $e');
      http.handleErrorResponse(error: e);
      rethrow;
